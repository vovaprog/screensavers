...
cp ../../mylib/ColorMap.cpp ../../mylib/ColorMap.h ../../mylib/fps.cpp ../../mylib/fps.h ../../mylib/ConstantFps.h ../../mylib/MovingValue.h $output_folder/mylib
...
mkdir $output_folder/external
cp -r ../../external/vectorclass $output_folder/external
