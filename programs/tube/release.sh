...
cp -r ./*.cpp ./Makefile ./release.sh $output_folder/program/$program


mkdir $output_folder/mylib
cp ../../mylib/ColorMap.cpp ../../mylib/ColorMap.h ../../mylib/ConstantFps.h $output_folder/mylib
...
cp -r ../../external/include/glm $output_folder/external/include
